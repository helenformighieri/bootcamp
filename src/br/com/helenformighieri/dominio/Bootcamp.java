...
public class Bootcamp {
    ...
    public void adicionarProjeto(Projeto projeto) {
        this.conteudos.add(projeto);
    }

    public Set<Conteudo> getProjetos() {
        return this.conteudos.stream()
                .filter(conteudo -> conteudo instanceof Projeto)
                .collect(Collectors.toSet());
    }

    public void adicionarHacking(Hacking hacking) {
        this.conteudos.add(hacking);
    }

    public Set<Conteudo> getHackings() {
        return this.conteudos.stream()
